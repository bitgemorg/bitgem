...
This mechanism has been integrated into Bitcore-Node-Gem which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/gempay/insight-api-gem#web-socket-api](https://github.com/gempay/insight-api-gem#web-socket-api)
* API: [https://github.com/gempay/insight-api-gem#instantsend-transactions](https://github.com/gempay/insight-api-gem#instantsend-transactions)
