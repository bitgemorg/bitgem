...
* gem.conf: contains configuration settings for gemd or gem-qt
* gemd.pid: stores the process id of gemd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by gemd or gem-qt
