# Linearize
Construct a linear, no-fork, best version of the Gem blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install gem_hash

https://github.com/gempay/gem_hash
...
JSON-RPC server. Running `gemd` or `gem-qt -server` will be sufficient.
...
* `input`: gemd blocks/ directory containing blkNNNNN.dat
