...
official/supported Docker Images found at https://hub.docker.com/r/gempay/gemd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/gempay/gemd-develop/ when changing the above text**