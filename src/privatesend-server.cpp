...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if (fLiteMode) return; // ignore all Gem related functionality
...
/*
    ...
    allow endless transaction that would bloat Gem and make it unusable. To
...
{
    if (fLiteMode) return;        // disable all Gem specific functionality
