...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Gem address\n"
            "  payee          - Print the masternode payout Gem address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting Gem address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "gem",               "masternode",             &masternode,             true,  {} },
    { "gem",               "masternodelist",         &masternodelist,         true,  {} },
    { "gem",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "gem",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
