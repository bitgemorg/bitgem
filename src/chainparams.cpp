...
// Copyright (c) 2014-2019 The Gem Core developers
...
{
    const char* pszTimestamp = "These gems have life in them: their colors speak, say what words fail of. - George Eliot";
...
public:
    CMainParams() {
        ...
        consensus.nMasternodePaymentsStartBlock = 7; // not true, but it's ok as long as it's less then nMasternodePaymentsIncreaseBlock
        ...
        consensus.nPowTargetTimespan = 30 * 60; // Gem: 20 minutes
        consensus.nPowTargetSpacing = 2.5 * 60; // Gem: 2.5 minutes
        ...
        vSeeds.push_back(CDNSSeedData("node1.bitgem.org", "node1.bitgem.org"));
        vSeeds.push_back(CDNSSeedData("node2.bitgem.org", "node2.bitgem.org"));
        vSeeds.push_back(CDNSSeedData("node3.bitgem.org", "node3.bitgem.org"));
        vSeeds.push_back(CDNSSeedData("node4.bitgem.org", "node4.bitgem.org"));
        vSeeds.push_back(CDNSSeedData("node5.bitgem.org", "node5.bitgem.org"));
        vSeeds.push_back(CDNSSeedData("node6.bitgem.org", "node6.bitgem.org"));
        vSeeds.push_back(CDNSSeedData("node7.bitgem.org", "node7.bitgem.org"));
        vSeeds.push_back(CDNSSeedData("node8.bitgem.org", "node8.bitgem.org"));
        vSeeds.push_back(CDNSSeedData("node9.bitgem.org", "node9.bitgem.org"));
        vSeeds.push_back(CDNSSeedData("node10.bitgem.org", "node10.bitgem.org"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,0x26);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,0x62);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,0xb1);
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x14)(0x18)(0x12)(0x1E).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x14)(0x28)(0x2D)(0x24).convert_to_container<std::vector<unsigned char> >();
        // Gem BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"GeyXj9pSfAFjYcEPRJwGHM6StVXJFzdJtH"};
        nMinSporkKeys = 1;
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("gemdot.io",  "testnet-seed.gemdot.io"));
        vSeeds.push_back(CDNSSeedData("masternode.io", "test.dnsseed.masternode.io"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,0x61);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,0x63);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,0xb2);
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x14)(0x18)(0x12)(0x1E).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x14)(0x28)(0x2D)(0x24).convert_to_container<std::vector<unsigned char> >();

        // Testnet Gem BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"gA1466LSrTYYN7LdwBSWCkZMJFiyvnRsTa"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;
...
public:
    CDevNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("gemevo.org",  "devnet-seed.gemevo.org"));
...
public:
    CRegTestParams() {
        ...
        // Regtest Gem BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
